...
from src.dataset.SymDataset.SymDatasetItem import SymDatasetItem, get_shape_type
from src.dataset.SymDataset.transforms.AbstractTransform import AbstractTransform
from src.dataset.SymDataset.transforms.ComposeTransform import ComposeTransform
from src.dataset.SymDataset.transforms.IdentityTransform import IdentityTransform
from src.dataset.SymDataset.transforms.RandomSampler import RandomSampler
from src.dataset.SymDataset.transforms.UnitSphereNormalization import UnitSphereNormalization
...
class SymDataset(Dataset):
    def __init__(
        ...
        self.filename_list = [
            ...
            if get_shape_type(filename) not in self.shape_excluded
        ]
    ...
    def _filename_from_idx(self, idx: int) -> Tuple[Path, str]:
        ...
        return fname, str(fname).replace('.xz', '.txt')
    ...
    def __getitem__(self, idx: int) -> SymDatasetItem:
        ...
        dataset_item = SymDatasetItem(
            ...
            transform_used, self.resolution
        )
